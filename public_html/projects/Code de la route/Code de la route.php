...
<body>
	<article id="d4f4023c-1a27-4170-bce9-3051e8d02daf" class="page sans">
		<header>
			<h1 class="page-title">Code de la route <span class="icon">🚗</span></h1>
		</header>
		<div class="page-body">
			<h2>Trucs à savoir pour le code de la route</h2>
			<ul class="toggle">
				<li>
					<details>
						<summary>Panneaux du code de la route</summary>
						<ul class="toggle">
							<li>
								<details>
						...
						<!-- <ul id="67dd2d46-69f2-4be4-a3ff-486f96b8f39d" class="toggle">
							<li>
								<details>
									<summary></summary>
								</details>
			...
			<ul class="toggle">
				<li>
					<details>
						<summary>Chiffres à absolument connaître</summary>
						<ul class="toggle">
							<li>
								<details>
						...
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>Calculer la distance de sécurité :</strong></summary>
									<p>On fait, dizaine de la vitesse
										fois 6, exemple : à 50km/h la distance de sécurité à garder est de 5x6 = 30,
										donc de 30 mètres.</p>
								</details>
							</li>
						</ul>
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>Calculer la distance parcourut en 1 seconde :</strong></summary>
									On fait, dizaine de la vitesse
									fois 3, exemple : à 90km/h la distance parcourue en 1 seconde est de 9x3 = 27,
									donc de 27 mètres en une seconde.</p>
								</details>
							</li>
						</ul>
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>Intervalle de temps à laisser entre nous même et le véhicule qui
											nous précède :</strong></summary>
									<p class="">Réponse : 2 secondes.</p>
								</details>
							</li>
						</ul>
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>L'alcoolémie maximale à ne pas dépasser pour un jeune
											conducteur :</strong></summary>
									<p>Réponse : 0,2 G/L de sang et
										0,1 MG/L d'air expiré. Pour le connaître on divise par 2 la réponse précédente.
									</p>
								</details>
							</li>
						</ul>
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>L'alcoolémie maximale à ne pas dépasser pour un conducteur
											expérimenté : </strong></summary>
									<p>Réponse : 0,5 G/L de sang.</p>
								</details>
							</li>
						</ul>
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>Pour signaler une panne ou un accident, le triangle de
											présignalisation doit être posé en amont du véhicule à au moins : </strong>
									</summary>
									<p class="">Réponse : 30 mètres.</p>
								</details>
							</li>
						</ul>
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>Numéro des services de secours en cas d'accident :</strong>
									</summary>
									<p>Réponse : 15 Samu, 18 Pompier,
										112 numéro valide dans toute l'UE.</p>
									<p>
									</p>
								</details>
							</li>
						...
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>Distance latérale de sécurité à laisser avec un usager vulnérable
											doit être d’au moins</strong></summary>
									<p>En ville : 1 mètre</p>
									<p>Hors agglomération : 1,5 mètre
									</p>
								</details>
							</li>
						</ul>
						<ul class="toggle">
							<li>
								<details>
									<summary><strong>Un enfant est autorisé à s'installer à l'avant de la voiture à
											partir de : </strong></summary>
									<p>Réponse 10 ans.</p>
									<p>
									</p>
								</details>
