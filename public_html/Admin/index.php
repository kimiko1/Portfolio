...
<body>
    ...
    <div class="info_perso">
        <?php foreach ($infos_perso as $p) : ?>
            <form action="">
                <textarea name="text" class="pres" id="">Bonjour et bienvenue sur le portfolio de <?php echo $p['surname'] . ' ' . $p["name"] ?>. J'ai actuellement 20 ans et je suis en <?php echo $p['activity'] ?></textarea>
